...
- An [introduction](https://github.com/kamimrcht/webpage/blob/master/files/presentation_ens_marchet.pdf) to data-structures for $k$-mer indexing for ENS Rennes students.
