...
- BiFrost has been one of the most successful datastructures for buildling compressed colored de Bruijn graphs in the last years, with notably an innovative unitig construction step. [GGCAT](https://www.biorxiv.org/content/10.1101/2022.10.24.513174v1) appears a nice improvement. [Bentley-Saxe Mantis](https://academic.oup.com/bioinformatics/article-abstract/38/12/3155/6553005?redirectedFrom=fulltext) brought more scalability and dynamicity.
- The field is composed of many combinations of fast evolving data-structures and ideas. A great idea is to enable mixing and matching different modules to see which combination works well. Well good news is, this is a WIP. You can learn more on the Piscem initiative in this [thread](https://twitter.com/nomad421/status/1592027245736067073?s=20&t=SCk8yx83EKuX1FAuZOhg6Q)
